document.addEventListener('DOMContentLoaded', () => {
  ...
  function rollDice() {
    ...
    const player1NewPosition = player1Position += diceRoll
    const squareToMoveTo = document.querySelector(`[data-id="${player1NewPosition}"]`)
    //add class of player1 to squareToMoveTo
    squareToMoveTo.classList.add('player1')
